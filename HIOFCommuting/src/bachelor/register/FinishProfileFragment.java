	...
	public void addOnClickListeners() {
		...
		finishButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
                ...
                System.out.println("userdata : " + address + " " + postalCode + " " + institution + " " + department + " " + study + " " + startingYear);
			...
			public void onItemSelected(AdapterView<?> parentView,
				...
				for(int i = 0; i < institutionObjects.size(); i++) {
					if(institutionObjects.get(i).getInstitutionName()==institution){
						...
						System.out.println("InstitutionID : "+ currentInstitutionId + "getInst :"+institutionObjects.get(i).getInstitutionId());
					}
				}
				...
				for(int i = 0; i < departmentObjects.size(); i++){
					if(departmentObjects.get(i).getInstitutionId()==currentInstitutionId){
						...
						System.out.println("DepartmentID : "+ departmentObjects.get(i));
					}
				}
			...
			public void onItemSelected(AdapterView<?> parentView,
				...
				for(int i = 0; i < departmentObjects.size(); i++) {
					if(departmentObjects.get(i).getDepartmentName()==campus){
						...
						System.out.println("CampusId : " + currentDepartmentId + "getCamp" + departmentObjects.get(i).getDepartmentId());
					}
				}
				...
				for(int i = 0; i < studyObjects.size(); i++){
					if(studyObjects.get(i).getDepartmentId()==currentDepartmentId){
						...
						System.out.println("studyId : " + studyObjects.get(i));
					}
				}
